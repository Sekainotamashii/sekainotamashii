/* 
	...
	Copyright © 2010-2011 Tyler Colwell
...
(function($){
	...
	$.fn.socialTrafficPop = function(options){
			...
			var defaults = {
				...
				google_url: "Sekainotamashii.blogspot.com",
				fb_url: "http://www.facebook.com/pages/Sekai-no-Tamashii/159310297462882",
				twitter_user: "SekaiNoTamashii",
			...
			getPopHTML = function() {
				...
				if(defaults.closeable == true){
					...
					spClose = '<a href="#" onClick="gppFlush();" id="gpp-close">Close<a/>';
				...
				if(defaults.twitter_method == "follow"){
					...
					var twitter_disp = '<a id="spTwitter" href="http://twitter.com/'+defaults.twitter_user+'" class="twitter-follow-button" data-show-count="false">Follow @'+defaults.twitter_user+'</a>';
					
				} else {
					
					var twitter_disp = '<a id="spTwitter" href="http://twitter.com/share" class="twitter-share-button">Tweet</a>';
					
				}
				
				var sPop = '<div id="stp-bg"></div><div id="stp-main"><div id="stp-title">'+spClose+''+defaults.title+'</div><div id="stp-msg-cont"><div id="stp-msg">'+defaults.message+'</div><div class="stp-button"><g:plusone size="standard" count="true" href="'+defaults.google_url+'" callback="googleCB"></g:plusone></div><div class="stp-button"><div id="fb-root"></div><fb:like href="'+defaults.fb_url+'" send="false" layout="button_count" width="50" show_faces="false"></fb:like></div><div class="stp-button">'+twitter_disp+'</div><div class="step-clear"></div></div><div id="stp-bottom"><div id="stp-counter">Comparte o espera <span id="stp-count"></span> segundos.</div></div></div>';
			...
			if(cook != 'true' && waitCook != 'true'){
				...
				$("#stp-main").css({"position": "absolute","top": 250,"left": windowWidth/2-popupWidth/2});
				...
				if(defaults.timeout == '0'){
					...
					$('#stp-count').countdown({until: '+'+defaults.timeout+'s', format: 'S', compact: true, description: '', onExpiry: stpFlush});
				...
				if(defaults.wait != 0){
					...
					createCookie('gppwait', 'true', defaults.wait);
